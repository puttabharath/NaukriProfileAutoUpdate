...
public class BasicDetailsEdit {
	...
	//Verify the functionality by giving invalid (Bharath@12) in the username input field
	public void nameInputFieldInvalid() throws Throwable {
		...
		Thread.sleep(4000); // given time for error to appear
	...
	//Verify the functionality by validating the Name field in Basic Details section
	//Verify the functionality by giving valid data in the username Input field
public void nameInputFieldValid() throws Throwable {
	...
	wait.until(ExpectedConditions.visibilityOf(NameField)).clear();
	Thread.sleep(3000);
	wait.until(ExpectedConditions.visibilityOf(NameField)).sendKeys("Bharath Kumar Putta");
